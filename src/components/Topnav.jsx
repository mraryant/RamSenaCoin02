...
const TopNavbar = () => {
  return (
    <>
      <nav className="navbar navbar-expand-lg " style={{ padding: "20px 20px", width: "100%", marginBottom: 1, }}>
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse navmain " id="navbarText">
            ...
            <ul className="navbar-nav centerbar " >
              ...
              <li className="nav-item">
                <a className="nav-link" href="#" style={{ color: "white", fontFamily: "Manrope" }}>Wallet</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#" style={{ color: "white", fontFamily: "Manrope" }}>About</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#" style={{ color: "white", fontFamily: "Manrope" }}>Tokenomics</a>
              </li>
            </ul>
            <span className="navbar-nav   mb-2 mb-lg-0">
